...
A family of related files (schema + loader + Python modules + tests) lives together rather than scattered across consumer skills. Skills JIT-load specific files within this directory; the directory itself is never loaded as a unit.
