...
**For 10+ holdings**: parallelise all fan-out calls (concurrency cap per conventions §3); if N≥2 calls time out, mark those holdings as "scores unavailable" and fall back to health-flags-only scoring for the missing positions.
