...
LEGACY_34 = frozenset({
    ...
    "parallax-country-deep-dive", "parallax-credit-lens", "parallax-deep-dive",
    "parallax-desk-call-list", "parallax-due-diligence",
    "parallax-earnings-quality", "parallax-explain-portfolio",
